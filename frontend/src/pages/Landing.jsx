    ...
    <div style={{ fontFamily: "'Inter', sans-serif", width: '100vw', overflowX: 'hidden', background: '#fff' }}>
      ...
      <section style={{ 
        ...
        <div style={{ position: 'relative', zIndex: 10, maxWidth: '800px', color: '#fff' }}>
          <h1 key={currentSlide} className="animate-fade-in" style={{ fontSize: '72px', fontWeight: '400', lineHeight: 1.1, marginBottom: '40px', fontFamily: "'Georgia', serif", whiteSpace: 'pre-line', animation: 'fadeIn 1s ease-in-out' }}>
      ...
      <section style={{ display: 'flex', flexDirection: 'column', padding: '40px 80px', background: '#f8fafc', borderBottom: '1px solid #e2e8f0' }}>
        <div style={{ display: 'flex', gap: '40px', marginBottom: '24px', borderBottom: '1px solid #e2e8f0', paddingBottom: '16px' }}>
          <h3 
        ...
        {infoTab === 'find' ? (
          <div className="animate-fade-in" style={{ display: 'flex', alignItems: 'flex-end', gap: '20px' }}>
            <div style={{ flex: 1 }}>
            ...
            <button 
              ...
              style={{ padding: '12px 32px', background: '#5b21b6', color: '#fff', border: 'none', borderRadius: '999px', fontWeight: 600, cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '8px' }}
            >
      ...
      <section style={{ padding: '80px', display: 'flex', gap: '80px', background: '#fff' }}>
        <div style={{ flex: 1 }}>
          <p style={{ color: '#64748b', fontSize: '13px', fontWeight: 600, marginBottom: '24px' }}>Why LemiCare Hospital?</p>
          <h2 style={{ fontSize: '42px', fontFamily: "'Georgia', serif", color: '#1e293b', marginBottom: '40px', lineHeight: 1.2 }}>
            Our team of experts<br />
            provides top-notch<br />
            medical treatment<br />
            with empathy using<br />
      ...
      <section style={{ padding: '80px', background: '#f8fafc' }}>
        ...
        <div className="animate-fade-in" key={deptTab + deptPage} style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr 1fr', gap: '20px', marginBottom: '40px' }}>
      ...
      {/* Support Services */}
      <section style={{ padding: '80px', background: 'linear-gradient(135deg, #0f766e 0%, #0369a1 100%)' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
          {[
            ...
            <div key={service.title} style={{ background: 'rgba(255,255,255,0.1)', backdropFilter: 'blur(8px)', display: 'flex', height: '160px', borderRadius: '10px', overflow: 'hidden', border: '1px solid rgba(255,255,255,0.2)', transition: 'background 0.2s' }} className="hover:bg-white/20 transition-colors">
              <div style={{ width: '160px', height: '100%', flexShrink: 0 }}>
      ...
      <section style={{ padding: '80px', background: '#fff' }}>
        ...
        <div style={{ display: 'flex', border: '1px solid #e2e8f0', borderRadius: '4px' }}>
          {[
            ...
            <div key={cert.title} style={{ flex: 1, padding: '40px', borderRight: index !== 2 ? '1px solid #e2e8f0' : 'none', display: 'flex', flexDirection: 'column' }}>
      ...
      <section style={{ padding: '80px', background: '#f8fafc' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '24px', marginBottom: '40px' }}>
          {[
            ...
            <div key={i} style={{ background: '#fff', border: '1px solid #e2e8f0', borderRadius: '6px', overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
              <div style={{ height: '260px', backgroundImage: `url(${blog.img})`, backgroundSize: 'cover', backgroundPosition: 'center', position: 'relative' }}>
      ...
      <section style={{ padding: '100px 80px', background: '#fff', display: 'flex', gap: '100px', alignItems: 'center' }}>
        <div style={{ flex: 1 }}>
          <svg width="48" height="48" viewBox="0 0 24 24" fill="#cbd5e1" style={{ marginBottom: '32px' }}>
            <path d="M14.017 21v-7.391c0-5.704 3.731-9.57 8.983-10.609l.995 2.151c-2.432.917-3.995 3.638-3.995 5.849h4v10h-9.983zm-14.017 0v-7.391c0-5.704 3.748-9.57 9-10.609l.996 2.151c-2.433.917-3.996 3.638-3.996 5.849h3.983v10h-9.983z"/>
          </svg>
          <h2 style={{ fontSize: '44px', fontFamily: "'Georgia', serif", color: '#1e293b', marginBottom: '32px', lineHeight: 1.2 }}>
            Healing for the Soul,<br />
            Unlocking the Secrets to<br />
            Recovery
          </h2>
